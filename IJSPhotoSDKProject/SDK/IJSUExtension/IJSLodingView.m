...
{
    IJSLodingView *lodingView = [[IJSLodingView alloc] initWithFrame:CGRectMake(0, 0, 150, 150)];
    ...
    UILabel *titleLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, 130, 150, 20)];
