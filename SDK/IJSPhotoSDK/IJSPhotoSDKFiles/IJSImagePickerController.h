...
@property (nonatomic, copy) void (^didFinishUserPickingImageHandle)(NSArray<UIImage *> *photos,NSArray *avPlayers,NSArray *assets,NSArray<NSDictionary *> *infos,BOOL isSelectOriginalPhoto);
/* 代理属性 */
