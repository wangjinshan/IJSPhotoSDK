...
{
    if (self.hiddenNavigationAndToos)
    {
        self.hiddenNavigationAndToos(self.hiddenToolsStatus);
    }
...
{
    UIView *anyView;
    if (self.assetModel.type == JSAssetModelMediaTypePhoto) anyView = self.backImageView;
    if (self.assetModel.type == JSAssetModelMediaTypeLivePhoto) anyView = self.livePhoto;
    if (self.assetModel.type == JSAssetModelMediaTypePhotoGif)  anyView = self.gifView;
    if (self.assetModel.type == JSAssetModelMediaTypeVideo) anyView = self.videoView;
    if (self.assetModel.type == JSAssetModelMediaTypeAudio) anyView = nil;
