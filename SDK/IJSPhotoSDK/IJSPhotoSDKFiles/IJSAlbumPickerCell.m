...
-(void) _createrUI
{
    ...
    arrowImage.image =[IJSFImageGet loadImageWithBundle:@"JSPhotoSDK" subFile:nil grandson:nil imageName:@"rightArrow" imageType:@"png"];
...
-(void)setModels:(IJSAlbumModel *)models
{
    ...
    [[IJSImageManager shareManager] getPostImageWithAlbumModel:models completion:^(UIImage *postImage) {
        self.thumbImageView.image = postImage;
    }];
